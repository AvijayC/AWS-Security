...
function credentialExchange(googleToken) {
  ...
  if (googleTokenDecoded['sub']) {
    ...
    AWS.config.credentials = new AWS.CognitoIdentityCredentials({
      IdentityPoolId: 'us-east-1:632da7ad-0337-4890-b773-7c014db175ab', // MAKE SURE YOU REPLACE THIS
      Logins: {
...
function accessImages() {
  ...
  var s3 = new AWS.S3();
  var params = {
    Bucket: "webidf-patchesprivatebucket-eyywdwytumot" // MAKE SURE YOU REPLACE THIS
  }; 
  ...
  s3.listObjects(params, function(err, data) {
    ...
    if (err) {
      ...
      var photos = data.Contents.map(function(photo) {
        ...
        // Return the HTML string of the safe element
      ...
      container.innerHTML = getHtml(photos); // photos already contains safe HTML from DOM methods
